...
do
     ...
     ./PrefixSumCuda -s 134217728  -m   >>Cuda/Cudafloat_mult.txt 
     ./PrefixSumCuda -s 134217728 -t double  -m    >>Cuda/CudaSize_mult_double.txt 

     ./PrefixSumCuda -s 268435456  -m   >>Cuda/Cudafloat_mult.txt 
     ./PrefixSumCuda -s 268435456 -t double  -m    >>Cuda/CudaSize_mult_double.txt 

     ./PrefixSumCuda -s 536870912  -m   >>Cuda/Cudafloat_mult.txt 
     ./PrefixSumCuda -s 536870912 -t double  -m    >>Cuda/CudaSize_mult_double.txt 

     ./PrefixSumCuda -s 1073741824  -m   >>Cuda/Cudafloat_mult.txt 
     ./PrefixSumCuda -s 1073741824 -t double  -m    >>Cuda/CudaSize_mult_double.txt 
